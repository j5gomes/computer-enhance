...
There is two things we can to improve the performance of a program:

- Reduce the number of instructions that you asking to the CPU;
- Increase the speed;

The number one multiplier why programs get slow if because of **WASTE**

![Simple Assembly Instructions](../media/Simple%20Assembly%20Instructions.png)


## ADD in C vs ADD in Python 
